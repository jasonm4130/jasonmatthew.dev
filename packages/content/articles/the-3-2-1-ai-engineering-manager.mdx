...
I wrote more about what I think "senior" actually means in [a separate post](/blog/what-is-a-senior). The short version is that force multiplication matters more than individual output, and AI is about to make that distinction impossible to ignore.
