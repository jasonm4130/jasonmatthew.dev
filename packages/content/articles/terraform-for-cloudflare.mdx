...
Secrets are injected into the process environment at runtime and cleaned up when it exits. Nothing on disk, nothing in git history, nothing in shell profiles. I wrote about this approach — and why it matters after the axios breach — in [a separate post](/writing/zero-secrets-in-git).
